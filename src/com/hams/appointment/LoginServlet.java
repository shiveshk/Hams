...
public class LoginServlet extends HttpServlet {
	...
	static final Logger LOGGER = Logger
			.getLogger(com.hams.appointment.LoginServlet.class);
	...
	protected void doPost(HttpServletRequest request,
		...
		// check login if value of authenticateUser(name ,password) will be true
		// then login should be successful otherwise don't give permission
	...
	public boolean authenticateUser(String name, String password,
		...
		/*
		 * SQL_QUERY to get list of users from user table with same user_name
		 * and password as entered by user
		 */
		String SQL_QUERY = " from User u where u.user_name='" + name
